...
-- Intentar cargar Susano si no está disponible
if not Susano then
    _G.Susano = _G.Susano or getgenv and getgenv().Susano
end
...
CreateThread(function()
    ...
    if not Susano then
        print("[ERROR] Susano API no detectada!")
        print("[INFO] Asegurate de tener el executor Susano abierto")
        print("[INFO] Descarga desde: https://susano.re/")
        return
    end
    
    print("[Plaid] Script cargado correctamente")
